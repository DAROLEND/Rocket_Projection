...
| ![Телеметрія + RAG-питання](static/images/preview/ask.png) | |
| **Телеметрія і RAG** — драг по траєкторії, і чат-режим «Питання» з confidence-беджем та посиланнями на симуляції | |
